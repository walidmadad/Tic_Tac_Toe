...
{
    public partial class Impossiblecs : Form
    {
        public Impossiblecs()
        {
            InitializeComponent();
                        ...
                        if (btn.Count != 0)
                        {
                            ...
                            if (button1.Text == "X" && tour_2.Visible)
                            {
                                ...
                                else
                                {
                                    ...
                                    else if (button9.Text == "X" && button1.Text == "X" && button4.Text=="")
                                    {
                                        this.tour_2.Visible = false;
                                        this.tour_1.Visible = true;
                                        robo(4);
                        ...
                        if (btn.Count != 0)
                        {
                            ...
                            if (button3.Text == "X" && tour_2.Visible)
                            {
                                ...
                                else
                                {
                                    ...
                                    else if (button7.Text == "X" && button3.Text == "X" && button6.Text == "")
                                    {
                                        this.tour_2.Visible = false;
                                        this.tour_1.Visible = true;
                                        robo(6);
                        ...
                        if (btn.Count != 0)
                        {
                            ...
                            if (button7.Text == "X" && tour_2.Visible)
                            {
                                ...
                                else
                                {
                                    ...
                                    else if (button3.Text == "X" && button7.Text == "X" && button4.Text == "")
                                    {
                                        this.tour_2.Visible = false;
                                        this.tour_1.Visible = true;
                                        robo(4);
                        ...
                        if (btn.Count != 0)
                        {
                            ...
                            if (button9.Text == "X" && tour_2.Visible)
                            {
                                ...
                                else
                                {
                                    ...
                                    else if (button1.Text == "X" && button9.Text == "X" && button6.Text == "")
                                    {
                                        this.tour_2.Visible = false;
                                        this.tour_1.Visible = true;
                                        robo(6);
